...
public class AssignmentDuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_description")).sendKeys("Lead for Selenium Automation and joined on July 2022");

		//Enter EmailAddress Field
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("priyankamalar08@gmail.com");
		...
		select.selectByVisibleText("America");
